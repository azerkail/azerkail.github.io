...
const items = ref([
    {
        image: "/images/ray-tracer.png",
        game: "Ray Tracer",
        job: "Personal Project - C++, CMake",
        body: `Personal project where I study an implementation of a Ray Tracer in pure C++. Currently following through the books Ray Tracing In One Weekend and its sequels, with the ultimate goal being to integrate BGFX and write a tiny engine that brings up a window and renders a simple scene in the GPU using Vulkan.
        \nThe source code is publicly available in my Github through the icon above.`
    },
    {
        image: "/images/sdt-logo.png",
        game: "Sonic Dream Team",
        job: "Software Engineer - Unity, C#",
    ...
    },
    {
        ...
        game: "Alloy",
        job: "Lead Web Developer - TypeScript, VueJS, Azure DevOps, HTML, CSS",
        body: `1. In one year I went from junior to lead web developer
        \n2. Saved the company’s flagship project Alloy, by spending 10 months working 12 hours a day rewriting the entire project from GWT to VueJS
    ...
    },
    {
        image: "/images/alloy.svg",
        game: "Alloy",
        job: "Full Stack Developer - .NET, C#",
    ...
    },
    {
        ...
        game: "iCliGo",
        job: "Full Stack Engineer - Laravel, PHP, VueJS, MySQL, HTML, CSS",
    ...
    },
    {
        ...
        game: "Bitclubs",
        job: "Junior Web Developer - HTML, CSS, JavaScript",
